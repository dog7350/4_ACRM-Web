<template>
    <div id="GunInfoRootWrapper" class="container-fluid m-0 p-0 d-flex flex-wrap justify-content-around">
        <div :style="`position: relative;`"
        class="container-fluid m-0 p-0 d-flex flex-wrap justify-content-around">

            <div id="gunInfoWrapper" :style="`${store.getters.GET_BROWSER_SIZE < 1000 && params.currentIndex !== index? 'position: fixed; top: 0; left:0;': ''}`"
            ...
            v-for="item, index in params.carList" :key="index">
                ...
                style="minWidth: 250px; overflow:hidden;">
                    ...
                    class="w-100 m-0 p-0 d-flex flex-wrap justify-content-center over-cursor" style="minWidth: 250px;minHeight: 200px; position:relative;">
                        <img class="container-fluid m-0 p-0 align-self-center" :src="`/images/guns/gun${index}.jpg`" alt="" style="width: 200px;">
                    ...
                    <div class="w-100 m-0 p-0 d-flex flew-wrap align-items-end">
                        <div @click="methods.isHaveArray(item.name) === -1?methods.buyGun(index): ()=>{params.carInfoVisible[index] = !params.carInfoVisible[index];}"
            ...
            buyGun: (gunIndex)=>{
                const callBack = (boolStat)=>{
                    if(store.getters.GET_IS_LOGIN === false){
                        ...
                        console.log(`${gunIndex} 무기 구매시도`);

                        axios.post(`/shop/what?num=${gunIndex+1}&type=0`)
                        .then((response)=>{
                        ...
                        console.log(`${gunIndex} 무기 구매를 취소했습니다.`);
                    }
                };
